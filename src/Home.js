...
import { /*Box, Button,  Paper,*/ Typography, Grid, IconButton } from '@mui/material'; //importing functions/variables, Typography, Grid and IconButton from the react library called Material UI. This is referenced from Material Ui documentsation: https://mui.com/components/
import NavBar from './NavBar'; // importing the function NavBar from NavBar.js file
import {motion, useMotionValueEvent, useScroll, useTransform, useSpring, useMotionValue} from 'framer-motion'; // importing functions/variables from the react library called Framer Motion. The is referenced from framer motiion documentation:https://www.framer.com/motion/component/ 
...
export default function Home() {
  ...
  return (
    <div className="App">
      ...
      <motion.header className="App-header" animate={{ opacity: 1}} initial={{ opacity:0}} transition={{duration: 3, ease: "easeOut"}}> {/*motion is added to the header elemeent to allow animations.  The fade animation is added to the componenets within this div, //This div is referenced from the ByteGrad YouTube Tutorial: https://www.youtube.com/watch?v=ajPPgKTViX8&t=32s*/}
      ...
      <motion.div ref={targetRef} class="text-white py-10" className='welcome'>
        ...
        <motion.div variants={fadeAnimations} initial="initial" whileInView="animate" viewport={{once: true,}}> {/*motion is added to the header elemeent to allow animations.  The fade animation is added to the componenets within this div, //This div is referenced from the ByteGrad YouTube Tutorial: https://www.youtube.com/watch?v=ajPPgKTViX8&t=32s*/}
